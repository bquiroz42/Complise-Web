...
export class VerServicioComponent implements OnInit {
  ...
  serviciosArray = [
    ...
    { nombre: 'Reparación de equipo', descripcion: 'Realizamos reparaciones a tu equipo de trabajo para que puedas seguir disfrutando de el, contamos con personal para arreglar computadoras, laptops, impresoras, perifericos, etc. Por lo que sientete seguro de que encontraras lo mejor a un buen precio.', imagen: 'assets/imagenes/img2.jpg' , id: 2 },
